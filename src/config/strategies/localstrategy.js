...
module.exports = function localStrategy(){
    passport.use(new Strategy({    // all this is, is telling passport that when youre using local.strategy, this is the method youre going to call to figure it out //if someone can be logged in or not
